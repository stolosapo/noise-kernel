...
const char* ArgumentParser::COMMAND_PREFIX = "--";
...
bool ArgumentParser::isCommand(string arg)
{
    int size = arg.size();
...
string ArgumentParser::trimCommand(string command)
{
...
ArgumentList ArgumentParser::parse(int argc, char* argv[])
{
...
void ArgumentParser::print(int argc, char* argv[])
{
